            ...
            <div className="mx-4 flex w-full max-w-lg flex-col gap-3 rounded-3xl bg-white p-8 shadow-xl sm:mx-auto lg:my-16">
                <div className=" flex flex-col gap-4">
                    ...
                    <div className="flex w-full gap-3">
                        ...
                        <input type="text" placeholder="Last Name" className="w-full rounded-md border border-gray-300 p-2" />
                    </div>
                    <input type="number" placeholder="Phone Number" className="w-full rounded-md border border-gray-300 p-2" />
                    <input type="email" placeholder="Email" className="w-full rounded-md border border-gray-300 p-2" />
                    <input type="password" placeholder="Create password" className="w-full rounded-md border border-gray-300 p-2" />
