    ...
    return (
        <div className="min-h-screen bg-gray-100">
            ...
            <div className="mx-auto flex min-h-screen flex-col md:flex-row">
                ...
                <div className='flex h-80 min-h-screen w-full flex-col gap-8 overflow-y-auto bg-gray-100 shadow-md sm:px-12 md:bg-white md:py-12 lg:justify-start' style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
